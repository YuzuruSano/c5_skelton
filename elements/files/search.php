...
?>
<style>
    div#ccm-file-manager-upload-prompt-02 {
       border:1px solid #e1e1e1;
       position: relative;
       margin-bottom: 20px;
       padding: 18px;
    }
    div#ccm-file-manager-upload-prompt-02 input[type="file"] {
        cursor: pointer;
        height: 55px;
        left: 0;
        opacity: 0;
    ...
    div#ccm-file-manager-upload-prompt-02 a {
        color: #acacac;
    ...
    div#ccm-file-manager-upload-prompt-02 a:hover {
        color: #333;
    }

    #ccm-dashboard-page div#ccm-file-manager-upload-prompt-02{
        display: none;
    }
